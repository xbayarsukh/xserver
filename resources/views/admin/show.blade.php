    ...
    <div class="bg-white p-4 rounded-lg shadow-lg w-96 mx-auto">
        ...
        <form action="{{ route('admin.filter') }}" method="POST">
            ...
            <div class="mt-4">
                ...
                <select name="year" id="year" class="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div class="mt-4">
                ...
                <select name="month" id="month" class="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200">
                    @for ($i = 1; $i <= 12; $i++)
                        @php
