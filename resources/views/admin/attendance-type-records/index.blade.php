    ...
    <div class="bg-gray-100 shadow-sm min-h-screen">
        <div class="container mx-auto px-4">
            ...
            <div class="shadow overflow-hidden rounded border-b border-gray-200 bg-white mt-10">
                ...
                <h1 class="text-2xl font-bold mb-4 text-left py-4 px-2">勤怠区分一覧</h1>

                <div class="flex flex-wrap gap-2 mb-4 px-2">
                    <x-button purpose="search" href="{{ url('/admin/attendance-type-records/create') }}">
                        新規登録
                    </x-button>
                    ...
                    <div class="table-responsive mt-10">
                        <table class="border-collapse border border-slate-400 min-w-full bg-white mt-5">
                            ...
                            <tbody>
                                @foreach ($attendanceTypeRecords as $index=>$record)
                                        ...
                                        <td class="border border-slate-300 px-4 py-2 ">
                                            ...
                                            <td class="border border-slate-300 px-4 py-2">
                                                <div class="action-buttons flex items-center space-x-2">
                                                    <a href="{{route('admin.attendance-type-records.edit',$record->id)}}" class="p-2 hover:bg-yellow-200 inline-flex items-center justify-center">
                                                        <img src="{{ asset('2.svg') }}" alt="編集" class="w-10 h-10">
                                                    </a>

                                                    <form action="{{ route('admin.attendance-type-records.destroy', $record) }}" method="POST" class="inline-flex">
                                                        @csrf
                                                        @method('DELETE')
