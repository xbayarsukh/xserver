<x-app-layout>
    ...
    <form action="{{ route('forms.store', '6A4') }}" method="POST">
        @csrf
        <div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            ...
            <div class="mb-4 flex border border-gray-500">
                <div class="flex w-full">
                    ...
                    <div class="w-1/2">
                        <label for="2" class="block text font-bold p-2">見舞い（災害）</label>
                    </div>
                </div>
            </div>
               ...
               <div class="mb-4 flex border border-gray-300">
                ...
                <div class="w-1/3 border-r border-gray-300 p-2">
                    <label for="breakdown1" class="block font-medium text-gray-700 mb-1">災害内容</label>
               ...
               <div class="mb-4 flex border border-gray-300">
                ...
                <div class="mb-4 flex flex-wrap border border-gray-500">
                    <div class="w-full text-center p-2">
                        <label for="11" class="font-bold text-gray-700">見舞い内容</label>
                    </div>
    ...
    <div>
        ...
        <label for="age" class="block font-medium text-gray-700 mb-1">災害内容詳細</label>
        <textarea class="form-input w-full" name="special1" id="special1" cols="30" rows="10" placeholder="
先日この地方を襲った台風１００号により、事務所及び倉庫が倒壊した。"></textarea>

    </div>
    <div>

        <label for="age" class="block font-medium text-gray-700 mb-1">特記事項</label>
        <textarea class="form-input w-full" name="special2" id="special2" cols="30" rows="10" placeholder="
Ｂランクの客先だが、菱工会役員のため、見舞い内容はＡランクと同等でお願いします。"></textarea>
