<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            <h1 class="text-3xl font-bold text-center mb-6">入院情告書</h1>
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    ...
                    <input type="text" id="patient_name" name="patient_name" class="form-input w-full" value="{{ $form->patient_name }}" readonly>
                </div>
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    ...
                    <input type="text" id="hospital_name" name="hospital_name" class="form-input w-full" value="{{ $form->hospital_name }}" readonly>
                </div>
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    ...
                    <input type="date" id="hospital_date_from" name="hospital_date_from" class="form-input w-full" value="{{ $form->hospital_date_from }}" readonly>
                </div>
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    ...
                    <input type="date" id="hospital_date_to" name="hospital_date_to" class="form-input w-full" value="{{ $form->hospital_date_to }}" readonly>
                </div>
