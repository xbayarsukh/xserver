<x-app-layout>
    ...
    <form action="{{ route('forms.store', '3C') }}" method="POST">
        @csrf
        <div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            ...
            @endif
            <h1 class="text-3xl font-bold text-center mb-6">退職届</h1>
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    <label for="job_left_date" class="block text font-medium text-gray-700 mb-1">退職年月日</label>
                    <input type="date" id="job_left_date" name="job_left_date" class="form-input w-full">
                </div>
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    <label for="address_furigana" class="block text font-medium text-gray-700 mb-1">退職後の住所連絡先(フリガナ)</label>
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    <label for="address" class="block text font-medium text-gray-700 mb-1">退職後の住所連絡先</label>
