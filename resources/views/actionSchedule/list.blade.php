            ...
            <div class="container mx-auto px-4">
                ...
                <div class="shadow overflow-hidden rounded border-b border-gray-200 bg-white mt-10">
                    ...
                    <h1 class="px-2 py-2 text-xl font-medium mb-6 mt-5">
                        行き先会社管理  {{ $office->office_name }}

                    </h1>


                    <h1 class="text-2xl font-bold mb-4 text-left py-4 px-2">行き先会社一覧</h1>
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-blue-50">
                                        ...
                                        <td class="border border-slate-300 px-4 py-2" data-label="動作">
                                            <div class="flex space-x-2"> <!-- Use flex and space-x-2 to align buttons horizontally -->
                                                <a href="{{ route('actionSchedule.edit', $record->id) }}" class="p-2 hover:bg-yellow-200 inline-block">
                                                    <img src="{{ asset('2.svg') }}" alt="編集" class="w-10 h-10">
                                                </a>
                                                <form action="{{ route('actionSchedule.destroy', $record->id) }}" method="POST" class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
